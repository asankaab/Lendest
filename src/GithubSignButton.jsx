...
export default function GithubSignButton() {
  ...
  async function githubSignin(e) {
    ...
    return (
        <Button fullWidth variant="outlined" onClick={githubSignin}>
            <Stack spacing={2} direction="row" alignItems="center">
                <img src="github-mark.svg" alt="Facebook Logo" width="20" height="20"/>
                <span>Github</span>
            </Stack>
            { errorMessages &&
